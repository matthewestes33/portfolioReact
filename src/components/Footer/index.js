...
function Footer() {   
    ...
    <div class="footer" id="footer">
        <a href="mailto:matthewestes@outlook.com"><img src="https://img.icons8.com/color/48/000000/send-mass-email.png" alt="Email" class="icon"/></a>
        <a href="https://github.com/matthewestes33"><img src="https://img.icons8.com/color/48/000000/github-2.png" alt="Github" class="icon"/></a>
